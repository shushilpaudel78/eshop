...
export const Counter:React.FC<numberprops> = ({ number, title, symbol }) => {
  return (
    <>
      <div className="flex flex-col w-full py-10 items-center bg-gradient-to-r from-purple-600 to-pink-300 lg:px-4  px-10 rounded-lg shadow-md">
        <div className="flex gap-2 bg-purple-300 lg:px-3 px-10 py-5 rounded-lg shadow-lg items-center justify-center">
